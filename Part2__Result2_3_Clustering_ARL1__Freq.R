...
# parallel computing
output2 <- foreach(i = 1:niter, # .export = c("scenario","delta"), 
  ...
  tmp_clustering_result <- c(rd, ard)
  PART2result_freq <- list(Frequentist = Part2_for_ARL1_freq, Clustering = tmp_clustering_result)
  # -------------------------------------------------------------------------------------------------
  #
  ###################################################################################################
  PART2result_freq
